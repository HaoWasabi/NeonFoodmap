...
export default function PartnerPortal() {
  ...
  const { isPlaying, isLoading, speakTTS, pause, load, play } = useAudioPlayer();
  ...
  const testIntro = () => { if (isPlaying) { pause(); return; } if (draft.introText) speakTTS(draft.introText, languageToBCP47(i18n.language)); };
