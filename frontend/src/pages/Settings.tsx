...
export default function Settings() {
  ...
  const VOICES: { value: VoiceRegion; label: string }[] = [
    { value: 'mien_nam', label: t('settings.voiceSouthLabel') },
    { value: 'mien_bac', label: t('settings.voiceNorthLabel') },
    { value: 'mien_trung', label: t('settings.voiceCentralLabel') }
  ];
